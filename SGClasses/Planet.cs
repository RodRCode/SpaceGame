...
namespace SGClasses
{
    public class Planet
    {
        ...
        public static List<Planet> PopulatePlanets()
        {
            ...
            var eddore = new Planet("Eddore", Location.randLocation(2, 20, 23, 47), "Eddore,  home to the Eddorians, a race of beings so foul and noxious as to be incomprehensible to the mind of man.  They are concentrated on never-ending conquest, always attempting to satisfy their insatiable lust for power.  They don't \"breed\", instead their capriciousness grows until one form can no longer contain it.  They then split like a gargantuan amoeba into two beings, both with a renewed desire to conquer and an a insatiable drive for power.  Yeah, going here is NOT a great idea, but, you do you.");
